...
<header>
    ...
    <form action="" method="POST"><!--formulario que lleva al proceso de update cuando se oprime el boton -->
        <?php
        ...
        <input type="submit" value="Actualizar" name="submitUpdate"><!-- Boton de actualizar que lleva al proceso_update -->
        <?php
